# otto mecanum class v0.0 23 Aug 2024
# Alex Etchells
# A class to control HP Otto with 4 wheel drive, particularly mecanum wheels
#
...
#functions above suit any 4WD, those below are mecamum wheel functions
