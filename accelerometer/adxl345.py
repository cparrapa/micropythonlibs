...
#See https://howtomechatronics.com/tutorials/arduino/how-to-track-orientation-with-arduino-and-adxl345-accelerometer/
...
class ADXL345:
    ...
    def rollpitch(self):
        ...
        roll2= math.atan2(x , math.sqrt(pow(x, 2) + pow(z, 2))) * 180 / math.pi;
