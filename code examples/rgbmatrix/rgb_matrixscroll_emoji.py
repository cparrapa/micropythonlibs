...
# Extended 5x7 font with lowercase and symbols
FONT = {
...
# Example: scroll multiple messages with different orientations and colorful emojis
messages = [
    {"text": "Hello ♥", "rotate": 0, "flip_h": False, "flip_v": False, "color": (255, 0, 0)},
    {"text": "NeoPixel ☺", "rotate": 270, "flip_h": True, "flip_v": False, "color": (0, 255, 0)},
    {"text": "MicroPython", "rotate": 180, "flip_h": False, "flip_v": True, "color": (0, 0, 255)},
]
