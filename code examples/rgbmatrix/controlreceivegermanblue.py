...
while True:
    ...
    if msg:             # msg == None if timeout in recv()
        if msg == b'A': # UP pressed forward
            ...
            motor.leftServo.duty(120- offset)
            motor.rightServo.duty(33+ offset)
        elif msg == b'AOff':
            ...
            motor.leftServo.duty(33- offset)
            motor.rightServo.duty(120+ offset)
            sleep(0.1)
        elif msg == b'Boff':
            ring.fillAllRing(0, 0, 0)
            ring.setRGBring(0, "fe0000")
            ...
            motor.rightServo.duty(50+ offset)
            motor.leftServo.duty(50- offset)
        elif msg == b'Coff':
            ring.fillAllRing(0, 0, 0)
            ring.setRGBring(0, "fe0000")
            motor.rightServo.duty(0)
