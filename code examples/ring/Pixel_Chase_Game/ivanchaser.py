...
def checkStatus():
    ...
    if button.value() == 0:
        ...
        if counter == randomNumber:
            ...
            turnOnAll(50, 0, 0)
        turnOff()
        randomNumber = random_int(0, no_pixels - 1)  # Ensure randomNumber is within the valid range
...
def setup():
    ...
    pixels.fill((0, 0, 0))
    pixels.write()
    randomNumber = round(random_int(0, no_pixels - 1))  # Ensure randomNumber is within the valid range
    showLevel()
