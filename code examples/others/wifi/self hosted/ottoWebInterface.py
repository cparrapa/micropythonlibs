#********************************************************
#        web page builder for HP Otto self hosted control
#               Alex Just-Alex Jan 2025
#********************************************************
...
def webpage(dist):
    ...
    html = f"""
            ...
            <html>
            <head>
            <title>HP Otto Self Hosted Web Control</title>
            <style>
            {CSS}
            </style>
            </head>
            <body>
            <div align = "center">
            <h1>HP Otto Self Hosted Web Control (PC interface)</h1>
...
def phonepage(dist):
    ...
    html = f"""
            ...
            <body>
            <div align = "center">
            <h1>HP Otto Self Hosted Web Control (Phone interface)</h1>
            <h2>Proof of Concept</h2>
            {CONTROL}
            <br />
            {MOVES}
...
def BLANKpage():
    ...
    html = f"""
            ...
            <body>
            <div align = "center">
            <h1>HP Otto Self Hosted Web Control</h1>
...
def movesTable():
    moves = """
    <h3 class='move'>Moves NOT CODED</h3>
              <table><tr>
...
def gesturesTable():
    gestures = """
     <h3  class='gesture'>Gestures NOT CODED</h3>
            <table><tr>
